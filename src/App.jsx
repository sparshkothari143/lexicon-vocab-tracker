      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
            ...
            <div style={{
              ...
              width: "44px", height: "44px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px",
            }}>📖</div>
          </div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              style={{
                width: "100%", background: "#161616", border: "1px solid #2A2A2A", borderRadius: "12px",
                padding: "12px 14px 12px 38px", color: "#E8E0D0", fontSize: "14px",
        ...
        <div style={{ padding: "0 20px" }}>
          {Object.keys(grouped).sort().map((letter) => (
            <div key={letter}>
              <div style={{
                fontSize: "11px", letterSpacing: "3px", color: "#C9A96E",
                textTransform: "uppercase", padding: "20px 0 8px", borderBottom: "1px solid #1A1A1A",
              }}>{letter}</div>
              ...
              {grouped[letter].map((w) => (
                <div key={w.id}>
                  <div
                    ...
                    style={{
                      padding: "16px 0", borderBottom: "1px solid #141414",
                  ...
                  >
                    ...
                    <span style={{
                      color: "#333", fontSize: "12px", marginLeft: "12px",
                  ...
                  {expandedId === w.id && (
                    <div style={{
                      ...
                      padding: "16px", marginBottom: "8px", animation: "fadeIn 0.2s ease",
                    }}>
                      ...
                      {w.example && (
                        <div style={{ marginBottom: "12px" }}>
                          ...
                          <div style={{
                            ...
                            borderLeft: "2px solid #C9A96E33", paddingLeft: "12px", fontStyle: "italic",
                          }}>"{w.example}"</div>
                        </div>
                      )}
                        ...
                        {deleteConfirm === w.id ? (
                          <div style={{ display: "flex", gap: "8px" }}>
                            <button onClick={() => setDeleteConfirm(null)} style={{
                              fontSize: "12px", background: "#1A1A1A", border: "1px solid #333",
                              color: "#888", padding: "4px 12px", borderRadius: "6px", cursor: "pointer",
                            }}>Cancel</button>
                            <button onClick={() => handleDelete(w.id)} style={{
                              fontSize: "12px", background: "#FF4444", border: "none",
                              color: "#fff", padding: "4px 12px", borderRadius: "6px", cursor: "pointer",
                            }}>Delete</button>
                          </div>
                        ) : (
                          <button onClick={(e) => { e.stopPropagation(); setDeleteConfirm(w.id); }} style={{
                            fontSize: "12px", background: "none", border: "1px solid #2A2A2A",
                            color: "#444", padding: "4px 12px", borderRadius: "6px", cursor: "pointer",
                          }}>Remove</button>
                        )}
                      </div>
                    </div>
        ...
        {!showForm && (
          <button onClick={() => setShowForm(true)} style={{
            ...
            background: "#C9A96E", border: "none", borderRadius: "50%",
            width: "56px", height: "56px", fontSize: "24px", cursor: "pointer",
            boxShadow: "0 4px 20px #C9A96E44", display: "flex",
        ...
        {saved && (
          <div style={{
            ...
            background: "#1A2A1A", border: "1px solid #2A4A2A", color: "#6ECF6E",
            padding: "10px 20px", borderRadius: "20px", fontSize: "13px", zIndex: 300,
          }}>✓ Word saved!</div>
        )}
        ...
        {showForm && (
          <div style={{
            ...
            <div style={{
              ...
              padding: "24px 20px 40px", width: "100%", borderTop: "1px solid #222",
                ...
                <div key={key} style={{ marginBottom: "14px" }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      borderRadius: "10px", padding: "11px 14px", color: "#E8E0D0",
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {["Noun", "Verb", "Adjective", "Adverb", "Idiom", "Phrase", "Other"].map((p) => (
                    <button key={p} onClick={() => setForm({ ...form, pos: p })} style={{
              ...
              <button onClick={handleAdd} disabled={!form.word.trim() || !form.meaning.trim()} style={{
                width: "100%",
